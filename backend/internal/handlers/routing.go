...
func (h *RoutingHandler) ProvideProxy(w http.ResponseWriter, r *http.Request) error {
	var key = proxyCID
...
func (h *RoutingHandler) FindProxyProvos(w http.ResponseWriter, r *http.Request) error {
	query := r.URL.Query()
